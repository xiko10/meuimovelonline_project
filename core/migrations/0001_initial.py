    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ativa', 'Ativa'), ('pendente', 'Pendente'), ('inativa', 'Inativa')], default='pendente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.CharField(blank=True, choices=[('superadmin', 'Super Admin'), ('anunciante', 'Anunciante'), ('gerente_anunciante', 'Gerente de Anunciante'), ('admin_imob', 'Admin de Imobiliária'), ('gerente', 'Gerente de Imobiliária'), ('corretor', 'Corretor'), ('cliente', 'Cliente')], max_length=20)),
                ...
                ('imobiliaria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='membros', to='core.imobiliaria')),
            ],
            options={
                'verbose_name': 'user',
